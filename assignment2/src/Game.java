...
//@ skipesc
  ...
  //invariants meant to prevent negative values in wonGame loop parameters for ESC
  //@ public invariant (board.ySize >= 0 );
  //@ public invariant (board.xSize >= 0 );
  //@ public invariant (board.items.length == board.xSize);
  //@ public invariant (board.items[0].length == board.ySize);
  //@ public invariant (board.items.length > 0);
  //@ public invariant (board.items[0].length > 0);
