 ...
 * test values for parameter "Board board" 
 * of method "Game(Board, Player)". 
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2014-10-28 13:53 +0100
 */
public /*@ nullable_by_default */ class Game_Game__Board_board__Player_player__0__board
  extends Game_ClassStrategy_Board {
  /**
  ...
  public RepeatedAccessIterator<?> localValues() {
    ...
    (new Object[]
     { /* add local-scope Board values or generators here */ });
  }

  /**
   * Constructor.
   * The use of reflection can be controlled here for  
   * "Board board" of method "Game(Board, Player)" 
   ...
   */
  public Game_Game__Board_board__Player_player__0__board() {
    super();
